...
DEFAULT_IMMUNE_IMAGE_DIR = "immune_images"
...
def parse_for_images(instance):
    ...
    immune_image_dir = instance.settings.get("IMMUNE_IMAGE_DIR", DEFAULT_IMMUNE_IMAGE_DIR)
    ...
    if instance._content is not None:
        ...
        for img in soup(['img', 'object']):
            ...
            img_src_dir = img['src'].split('/')[1]
            # Replace all non-immune images with their dithers:
            if img_src_dir != immune_image_dir:
